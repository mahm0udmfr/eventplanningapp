...
class _EditEventScreenState extends State<EditEventScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      setState(() {
        ...
        discriptionController.text = args.discription;
        selectedDate = args.dateTime;
        selectedTime = TimeOfDay.fromDateTime(DateFormat.jm().parse(args.time));
        selectedEvent = args.eventName;
        eventListProvider.selectedIndex = args.selectedCatId - 1;
      });
    });
  }
  ...
  void editEvent() {
    if (formKey.currentState!.validate() == true) {
      ...
      FirebaseUtils.editEventCollection(event, userProvider.currentUser!.id)
          .then((value) {
        eventListProvider.changeSelectedIndex(0, context);
        ShowToast.toast("Data Updated");
      }).timeout(
